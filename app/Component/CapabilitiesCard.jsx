...
const CapabilitiesCard = ({ data }) => {
  ...
  return (
    <div className="card rounded-2xl w-full h-full bg-white shadow-xl hover:shadow-2xl hover:border hover:border-teal-100">
      <figure className="px-2 w-full  md:px-4 pt-10 pb-4">
        <Image src={logo} alt="member" width={60} />
      </figure>
      <h2 className=" font-bold text-lg md:text-2xl text-black text-center">
        {title}
      </h2>
