    ...
    <ul className="bg-white h-screen  p-8 text-black">
      ...
      <li className=" flex flex-col pt-2 gap-1">
        ...
        <p className=" font-normal text-gray-500 ">
          ...
          materials on MakemyAI.in&lsquo;s website for personal, non-commercial
      ...
      <li className=" flex flex-col pt-2 gap-1">
        ...
        <p className=" font-normal text-gray-500 ">
          The materials on MakemyAI.in&lsquo;s website are provided on an
          &lsquo;as is&lsquo; basis. MakemyAI.in makes no warranties, expressed
      ...
      <li className=" flex flex-col pt-2 gap-1">
        ...
        <p className=" font-normal text-gray-500 ">
          ...
          inability to use the materials on MakemyAI.in&lsquo;s website, even if
